...
class TestSith(unittest.TestCase):
    def setUp(self):
        self.player = Sith("Darth Vader")
        self.other = Sith("Darth Maul")

    def test_init(self):
        self.assertEqual(self.player.name, "Darth Vader")

    def test_getter_setter_name(self):
        self.player.name = "Lord Vader"
        self.assertEqual(self.player.name, "Lord Vader")
    ...
    def test_meditate_2(self):
        ...
        self.player.health = 70
        self.player.meditate()
        self.assertEqual(self.player.health, 77)
    ...
    def test_use_force(self):
        ...
        self.assertEqual(self.player.agility, 45)
        self.assertEqual(self.player.force, 40)
